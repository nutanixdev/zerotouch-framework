...
class UpdateCvmFoundation(CvmScript):
    ...
    def execute_single_cvm(self, cvm_ip: str, cvm_details: Dict):
        ...
        try:
            ...
            status, error_message = ssh_cvm.update_cvm_foundation(
                foundation_url_path=cvm_details["foundation_build_url"],
            ...
            self.exceptions.append(f"Exception occurred while updating CVM Foundation: {e}")
