...
from .helpers.objects.buckets import Buckets
from .helpers.objects.objectstore import ObjectStore
            ...
            if os_obj:
                ...
                for bucket_to_create in object_store.get("buckets", []):
                    try:
                        ...
                        self.logger.debug(e)
                        self.logger.info(
                            f"Exception occurred during the verification of '{type(self).__name__}'")
