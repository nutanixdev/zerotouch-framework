...
class CreateRoleMappingPc(Script):
    ...
    def execute(self, **kwargs):
        try:
            ...
            if not self.authn_payload.get("ad_name") and not self.authn_payload.get("role_mappings"):
            ...
            for role_mapping in self.authn_payload["role_mappings"]:
                ...
                self.logger.info(f"Creating new role-mapping for the PC '{self.data['pc_ip']}'")
